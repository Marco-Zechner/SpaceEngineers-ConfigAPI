...
set STEAM_PATH=E:\SteamLibrary

rem	3. Edit this with your mod's workshop id.
set WORKSHOP_ID=2891367014
rem     steamID of ImprovisedExperimentation, so install that on the DS and client, it will then be replaced. (probably needs to be redownloaded if you want to use it normally after)
